...
def run_pipnet(args=None):
   ...
   # with torch.no_grad():
    ...
    for epoch in range(1, args.epochs + 1):                      
        epochs_to_finetune = 0 #during finetuning, only train classification layer and freeze rest. usually done for a few epochs (at least 1, more depends on size of dataset)
