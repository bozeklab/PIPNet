...
def run_pipnet(args=None):
    ...
    for epoch in range(1, args.epochs_pretrain + 1):
        ...
        train_info = train_pipnet(net, trainloader_pretraining, optimizer_net, optimizer_classifier, scheduler_net,
                                  ...
                                  global_step_base=pretrain_base, finetune=False)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        train_info = train_pipnet(net, trainloader, optimizer_net, optimizer_classifier, scheduler_net,
                                  ...
                                  global_step_base=stage2_base, finetune=finetune)
        ...
        log.log_values('log_epoch_overview', epoch, eval_info['top1_accuracy'], eval_info['top5_accuracy'],
                       ...
                       eval_info['almost_nonzeros'], eval_info['num non-zero prototypes'], train_info['train_accuracy'],
                       train_info['loss'])
