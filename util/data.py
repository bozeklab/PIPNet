...
def get_data(args: argparse.Namespace):
    ...
    if args.dataset == 'grayscale_mito':
        return get_grayscale(True, '/home/pwojcik/mito_work/dataset_512/train',
                             '/home/pwojcik/mito_work/dataset_512/train',
                             '/home/pwojcik/mito_work/dataset_512/test', args.image_size, args.image_size_ds,
                             args.seed,
                             args.validation_size,
...
def shuffle_image_patches(img, patch_size=32):
    ...
    img_tensor = img#F.to_tensor(img)
